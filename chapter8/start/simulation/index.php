...
<head>
    <title>Image Uploader with Progress (Simulation)</title>
...
<body>
    <h1>Image Uploader with Progress (Simulation)</h1>
    <div id="content">
        ...
        <div id="browserPane">
            <h2><span id="fileCount"><?php echo count($files); ?></span> Existing Files in <em>uploads/</em></h2>
            <ul id="fileList">
                <?php echo join($files,"\n\t\t"); ?>
            </ul>
        </div>
